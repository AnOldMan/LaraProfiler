...
class Captcha {
	...
	public static function name() {
		...
		if( function_exists( 'imagejpeg' ) ) $ext = 'jpg';
	...
	public static function img() {
		...
		return self::url().'?'.mt_rand(1, 100000); //add a random number to avoid browser caching issues
	}
	...
	public static function generate()
	{
		...
		return Response::serveImageResource( $img2, static::$jpeg_quality, self::name() );
	}
}
