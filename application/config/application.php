...
return array(
	...
	*/
	...
	|--------------------------------------------------------------------------
	|
	| The base URL used for your application's uploaded files. You should
	| designate a single upload directory for this purpose.
	| ( recommended: public-root/files/ )
	| If it is not set, we'll default to the application URL above.
	|
	*/
	...
	|--------------------------------------------------------------------------
	|
	| The base filesystem path used for your application's uploaded files. This
	| is useful if you are serving your assets through a different server or a
	| CDN.
	|
	| This is split in case you need to explicitly define the base path
	| i.e.: /var/www/somesite.com/ for personal devs
	|
	*/

	'files_path' => path('public') . DS . 'files' . DS,
