...
(function ($) {
    ...
    $jQval.addMethod("mustbetrue", function (value, element, params) {
        return element.checked || $(element).is(':checked');
    });

    adapters.addBool("mustbetrue");
